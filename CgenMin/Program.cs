...
namespace CodeGenerator
{
    ...
    public class Program
    {
        ...
        //TODO: maybe have this directory setable in a config file or something.
...
//        public static string envIronDirectory = @"/home/user/QR_Sync/CgenMin";//@"C:\QR_sync";
        ...
        //public static string envIronDirectory = @"/home/user/QR_Sync/CgenMin/CgenMin/macro2Test";
        //public static string envIronDirectory = @"/home/user/HelloWorld"; fb
        ...
        { 
            ...
            }else
            {
                ...
                QRBaseDir = Path.Combine(@"/"+$"{items[0]}", $"{items[1]}", $"QR_Sync"); 
            ...
            Action RunParser = () =>
            {
                Parser.Default.ParseArguments<MacroOptions, Macro2Options, QRInitOptions, QR_launchOptions, QR_runOptions>(command)
